...
<form action="paket_proses.php" method="POST" role="form">
	...
	<div class="row">
		...
		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">		
			...
			<h5>Durasi Wisata (Optional)</h5>
			<div class="row">

				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
					<div class="form-group">
						<label for="durasi_jam">Jam</label>
						<input name="durasi_jam" type="text" class="form-control" id="durasi_jam"  placeholder="Masukkan durasi_jam" value="<?php echo (!empty($durasi_jam)?$durasi_jam:''); ?>">

					</div>
				</div>
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
					<div class="form-group">
						<label for="durasi_hari">Hari</label>
						<input name="durasi_hari" type="text" class="form-control" id="durasi_hari"  placeholder="Masukkan durasi_hari" value="<?php echo (!empty($durasi_hari)?$durasi_hari:''); ?>">

					</div>
				</div>
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
					<div class="form-group">
						<label for="durasi_malam">Malam</label>
						<input name="durasi_malam" type="text" class="form-control" id="durasi_malam"  placeholder="Masukkan durasi_malam" value="<?php echo (!empty($durasi_malam)?$durasi_malam:''); ?>">
